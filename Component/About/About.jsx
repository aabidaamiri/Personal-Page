                ...
                <div class="divi">
                    <div class="left">
                        ...
                        <section class="leftsec">
                            <div class="leftsec-1">
                                <div>
                                    <h2 class="img"><FaRegCalendar /></h2>
                                    <h5> <span class="dob">Date of Birth:</span> 29 Aug 2000</h5>
                                </div>

                                <div>
                                    <h2 class="img"><CiPhone /></h2>
                                    <h5> <span class="dob">Phone:</span>+93 78 333 333</h5>
                                </div>

                                <div>
                                    <h2 class="img"><SlGraduation /></h2>
                            ...
                            <div class="leftsec-1">
                                <div>
                                    <h2 class="img"><MdOutlineMail /></h2>
                                    <h5> <span class="dob">Email:</span> aabidaamiri@gmail.com</h5>
                                </div>

                                <div>
                                    <h2 class="img"><IoLocationOutline /></h2>
                                    <h5> <span class="dob">Location:</span>Kabul, Afghanistan</h5>
                                </div>

                                <div>
                                    <h2 class="img"><CgWebsite /></h2>
                                    <h5> <span class="dob">website:</span>www.aabipage.com</h5>
                                </div>
                            </div>
